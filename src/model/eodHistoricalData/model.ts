...
export type NumberDividendsByYear = { [key: number]: EHDNumberDividendsForYear };
...
export enum EHDBeforeAfterMarket {
  BEFORE_MARKET = 'BeforeMarket',
  AFTER_MARKET = 'AfterMarket',
}

// reportDate and date is date in the form of '2023-01-01'
export interface EHDEarningsHistorical {
  reportDate: string
  date: string
  beforeAfterMarket: EHDBeforeAfterMarket,
  currency: EHDCurrencyCode,
  epsActual: number
...
// key is date in the form of '2023-01-01'
...
export interface EHDBalanceSheet {
  ...
  currentDeferredRevenue: string | null,
  netDebt: string
...
export type EHDSearchResponse = EHDSearchResult[];
